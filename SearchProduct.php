...
/// SELECT ALL //
$sql = "SELECT * FROM product WHERE name LIKE '%$search%' OR WHERE categorie LIKE '%$search%' OR WHERE size LIKE '%$search%' WHERE sexe LIKE '%$search%' OR WHERE color LIKE '%$search%'";
